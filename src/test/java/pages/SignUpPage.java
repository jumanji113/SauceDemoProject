...
public class SignUpPage {
    ...
    private SelenideElement  allTextLogins = $x("//div[@id='login_credentials']");
    private SelenideElement  allFullPassword = $x("//div[@data-test='login-password']");
    private SelenideElement  loginInput = $x("//input[@id='user-name']");
    private SelenideElement  passwordInput = $x("//input[@id='password']");
    private SelenideElement  signUpButton = $x("//input[@id='login-button']");
